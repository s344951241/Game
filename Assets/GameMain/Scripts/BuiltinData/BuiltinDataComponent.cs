...
namespace Game
{
    public class BuiltinDataComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private VideoClip m_SplashMovie = null;

        public VideoClip SplashMovie { get { return m_SplashMovie; } }

        [SerializeField]
        private bool m_SplashCanSkip = false;

        public bool SplashCanSkip { get { return m_SplashCanSkip; } }
        ...
        public void InitDefaultDictionary()
        {
            ...
            m_DefaultDictionaryTextAsset = null;
        }
    }
}
