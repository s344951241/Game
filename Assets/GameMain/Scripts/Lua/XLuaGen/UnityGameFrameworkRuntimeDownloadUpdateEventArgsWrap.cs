...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityGameFrameworkRuntimeDownloadUpdateEventArgsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityGameFramework.Runtime.DownloadUpdateEventArgs);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "EventId", UnityGameFramework.Runtime.DownloadUpdateEventArgs.EventId);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityGameFramework.Runtime.DownloadUpdateEventArgs __cl_gen_ret = new UnityGameFramework.Runtime.DownloadUpdateEventArgs();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityGameFramework.Runtime.DownloadUpdateEventArgs constructor!");
        ...
        static int _m_Clear(RealStatePtr L)
        {
		    try {
                ...
                UnityGameFramework.Runtime.DownloadUpdateEventArgs __cl_gen_to_be_invoked = (UnityGameFramework.Runtime.DownloadUpdateEventArgs)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Fill(RealStatePtr L)
        {
		    try {
                ...
                {
                    GameFramework.Download.DownloadUpdateEventArgs e = (GameFramework.Download.DownloadUpdateEventArgs)translator.GetObject(L, 2, typeof(GameFramework.Download.DownloadUpdateEventArgs));
                    
                        UnityGameFramework.Runtime.DownloadUpdateEventArgs __cl_gen_ret = __cl_gen_to_be_invoked.Fill( e );
                        translator.Push(L, __cl_gen_ret);
