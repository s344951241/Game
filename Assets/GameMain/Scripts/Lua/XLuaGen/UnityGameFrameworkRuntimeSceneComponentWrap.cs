    ...
    public class UnityGameFrameworkRuntimeSceneComponentWrap 
    {
        ...
        static int _m_GetLoadedSceneAssetNames(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.Collections.Generic.List<string> results = (System.Collections.Generic.List<string>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<string>));
                    
                    __cl_gen_to_be_invoked.GetLoadedSceneAssetNames( results );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityGameFramework.Runtime.SceneComponent.GetLoadedSceneAssetNames!");
        ...
        static int _m_GetLoadingSceneAssetNames(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Collections.Generic.List<string>>(L, 2)) 
                {
                    ...
                    __cl_gen_to_be_invoked.GetLoadingSceneAssetNames( results );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityGameFramework.Runtime.SceneComponent.GetLoadingSceneAssetNames!");
        ...
        static int _m_GetUnloadingSceneAssetNames(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Collections.Generic.List<string>>(L, 2)) 
                {
                    ...
                    __cl_gen_to_be_invoked.GetUnloadingSceneAssetNames( results );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityGameFramework.Runtime.SceneComponent.GetUnloadingSceneAssetNames!");
        ...
        static int _m_LoadScene(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    __cl_gen_to_be_invoked.LoadScene( sceneAssetName, priority );
                ...
                if(__gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<object>(L, 4)) 
                {
                    ...
                    __cl_gen_to_be_invoked.LoadScene( sceneAssetName, priority, userData );
