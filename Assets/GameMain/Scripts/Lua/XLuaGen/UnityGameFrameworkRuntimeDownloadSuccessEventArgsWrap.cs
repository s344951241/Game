...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityGameFrameworkRuntimeDownloadSuccessEventArgsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityGameFramework.Runtime.DownloadSuccessEventArgs);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "EventId", UnityGameFramework.Runtime.DownloadSuccessEventArgs.EventId);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityGameFramework.Runtime.DownloadSuccessEventArgs __cl_gen_ret = new UnityGameFramework.Runtime.DownloadSuccessEventArgs();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityGameFramework.Runtime.DownloadSuccessEventArgs constructor!");
        ...
        static int _m_Clear(RealStatePtr L)
        {
		    try {
                ...
                UnityGameFramework.Runtime.DownloadSuccessEventArgs __cl_gen_to_be_invoked = (UnityGameFramework.Runtime.DownloadSuccessEventArgs)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Fill(RealStatePtr L)
        {
		    try {
                ...
                {
                    GameFramework.Download.DownloadSuccessEventArgs e = (GameFramework.Download.DownloadSuccessEventArgs)translator.GetObject(L, 2, typeof(GameFramework.Download.DownloadSuccessEventArgs));
                    
                        UnityGameFramework.Runtime.DownloadSuccessEventArgs __cl_gen_ret = __cl_gen_to_be_invoked.Fill( e );
                        translator.Push(L, __cl_gen_ret);
