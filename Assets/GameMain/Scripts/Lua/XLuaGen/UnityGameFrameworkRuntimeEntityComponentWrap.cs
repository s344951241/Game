    ...
    public class UnityGameFrameworkRuntimeEntityComponentWrap 
    {
        ...
        static int _m_GetAllEntityGroups(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Collections.Generic.List<GameFramework.Entity.IEntityGroup>>(L, 2)) 
                {
                    System.Collections.Generic.List<GameFramework.Entity.IEntityGroup> results = (System.Collections.Generic.List<GameFramework.Entity.IEntityGroup>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<GameFramework.Entity.IEntityGroup>));
                    
                    __cl_gen_to_be_invoked.GetAllEntityGroups( results );
        ...
        static int _m_GetEntities(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Collections.Generic.List<UnityGameFramework.Runtime.Entity>>(L, 3)) 
                {
                    string entityAssetName = LuaAPI.lua_tostring(L, 2);
                    System.Collections.Generic.List<UnityGameFramework.Runtime.Entity> results = (System.Collections.Generic.List<UnityGameFramework.Runtime.Entity>)translator.GetObject(L, 3, typeof(System.Collections.Generic.List<UnityGameFramework.Runtime.Entity>));
                    
                    __cl_gen_to_be_invoked.GetEntities( entityAssetName, results );
        ...
        static int _m_GetAllLoadedEntities(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Collections.Generic.List<UnityGameFramework.Runtime.Entity>>(L, 2)) 
                {
                    System.Collections.Generic.List<UnityGameFramework.Runtime.Entity> results = (System.Collections.Generic.List<UnityGameFramework.Runtime.Entity>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<UnityGameFramework.Runtime.Entity>));
                    
                    __cl_gen_to_be_invoked.GetAllLoadedEntities( results );
        ...
        static int _m_GetAllLoadingEntityIds(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.Collections.Generic.List<int> results = (System.Collections.Generic.List<int>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<int>));
                    
                    __cl_gen_to_be_invoked.GetAllLoadingEntityIds( results );
        ...
        static int _m_ShowEntity(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 6&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<System.Type>(L, 3)&& (LuaAPI.lua_isnil(L, 4) || LuaAPI.lua_type(L, 4) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 5) || LuaAPI.lua_type(L, 5) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)) 
                {
                    int entityId = LuaAPI.xlua_tointeger(L, 2);
                    System.Type entityLogicType = (System.Type)translator.GetObject(L, 3, typeof(System.Type));
                    string entityAssetName = LuaAPI.lua_tostring(L, 4);
                    ...
                    __cl_gen_to_be_invoked.ShowEntity( entityId, entityLogicType, entityAssetName, entityGroupName, priority );
                ...
                if(__gen_param_count == 7&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<System.Type>(L, 3)&& (LuaAPI.lua_isnil(L, 4) || LuaAPI.lua_type(L, 4) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 5) || LuaAPI.lua_type(L, 5) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)&& translator.Assignable<object>(L, 7)) 
                {
                    int entityId = LuaAPI.xlua_tointeger(L, 2);
                    System.Type entityLogicType = (System.Type)translator.GetObject(L, 3, typeof(System.Type));
                    string entityAssetName = LuaAPI.lua_tostring(L, 4);
                    ...
                    __cl_gen_to_be_invoked.ShowEntity( entityId, entityLogicType, entityAssetName, entityGroupName, priority, userData );
        ...
        static int _m_GetChildEntities(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<System.Collections.Generic.List<GameFramework.Entity.IEntity>>(L, 3)) 
                {
                    int parentEntityId = LuaAPI.xlua_tointeger(L, 2);
                    System.Collections.Generic.List<GameFramework.Entity.IEntity> results = (System.Collections.Generic.List<GameFramework.Entity.IEntity>)translator.GetObject(L, 3, typeof(System.Collections.Generic.List<GameFramework.Entity.IEntity>));
                    
                    __cl_gen_to_be_invoked.GetChildEntities( parentEntityId, results );
                    
                    
                    
                    return 0;
                }
                if(__gen_param_count == 3&& translator.Assignable<GameFramework.Entity.IEntity>(L, 2)&& translator.Assignable<System.Collections.Generic.List<GameFramework.Entity.IEntity>>(L, 3)) 
                {
                    GameFramework.Entity.IEntity parentEntity = (GameFramework.Entity.IEntity)translator.GetObject(L, 2, typeof(GameFramework.Entity.IEntity));
                    System.Collections.Generic.List<GameFramework.Entity.IEntity> results = (System.Collections.Generic.List<GameFramework.Entity.IEntity>)translator.GetObject(L, 3, typeof(System.Collections.Generic.List<GameFramework.Entity.IEntity>));
                    
                    __cl_gen_to_be_invoked.GetChildEntities( parentEntity, results );
        ...
        static int _m_SetEntityInstanceLocked(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetEntityInstanceLocked( entity, locked );
