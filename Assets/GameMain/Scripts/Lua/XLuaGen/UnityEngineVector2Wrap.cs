...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineVector2Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 17, 8, 0);
        ...
        static int _m_ToVector3(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 1) 
                {
                        ...
                        UnityEngine.Vector3 __cl_gen_ret = __cl_gen_to_be_invoked.ToVector3(  );
                ...
                if(__gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    float y = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        UnityEngine.Vector3 __cl_gen_ret = __cl_gen_to_be_invoked.ToVector3( y );
                        translator.PushUnityEngineVector3(L, __cl_gen_ret);
