...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityGameFrameworkRuntimeOpenUIFormUpdateEventArgsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityGameFramework.Runtime.OpenUIFormUpdateEventArgs);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "EventId", UnityGameFramework.Runtime.OpenUIFormUpdateEventArgs.EventId);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityGameFramework.Runtime.OpenUIFormUpdateEventArgs __cl_gen_ret = new UnityGameFramework.Runtime.OpenUIFormUpdateEventArgs();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityGameFramework.Runtime.OpenUIFormUpdateEventArgs constructor!");
        ...
        static int _m_Clear(RealStatePtr L)
        {
		    try {
                ...
                UnityGameFramework.Runtime.OpenUIFormUpdateEventArgs __cl_gen_to_be_invoked = (UnityGameFramework.Runtime.OpenUIFormUpdateEventArgs)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Fill(RealStatePtr L)
        {
		    try {
                ...
                {
                    GameFramework.UI.OpenUIFormUpdateEventArgs e = (GameFramework.UI.OpenUIFormUpdateEventArgs)translator.GetObject(L, 2, typeof(GameFramework.UI.OpenUIFormUpdateEventArgs));
                    
                        UnityGameFramework.Runtime.OpenUIFormUpdateEventArgs __cl_gen_ret = __cl_gen_to_be_invoked.Fill( e );
                        translator.Push(L, __cl_gen_ret);
