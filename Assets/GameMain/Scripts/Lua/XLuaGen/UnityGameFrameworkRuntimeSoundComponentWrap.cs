    ...
    public class UnityGameFrameworkRuntimeSoundComponentWrap 
    {
        ...
        static int _m_GetAllSoundGroups(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Collections.Generic.List<GameFramework.Sound.ISoundGroup>>(L, 2)) 
                {
                    System.Collections.Generic.List<GameFramework.Sound.ISoundGroup> results = (System.Collections.Generic.List<GameFramework.Sound.ISoundGroup>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<GameFramework.Sound.ISoundGroup>));
                    
                    __cl_gen_to_be_invoked.GetAllSoundGroups( results );
        ...
        static int _m_GetAllLoadingSoundSerialIds(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Collections.Generic.List<int>>(L, 2)) 
                {
                    ...
                    __cl_gen_to_be_invoked.GetAllLoadingSoundSerialIds( results );
		    ...
		    try {
                ...
                if(__gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    int priority = LuaAPI.xlua_tointeger(L, 4);
                        ...
                        int __cl_gen_ret = __cl_gen_to_be_invoked.PlaySound( soundAssetName, soundGroupName, priority );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 5&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& translator.Assignable<GameFramework.Sound.PlaySoundParams>(L, 5)) 
                {
                    string soundAssetName = LuaAPI.lua_tostring(L, 2);
                    string soundGroupName = LuaAPI.lua_tostring(L, 3);
                    int priority = LuaAPI.xlua_tointeger(L, 4);
                    GameFramework.Sound.PlaySoundParams playSoundParams = (GameFramework.Sound.PlaySoundParams)translator.GetObject(L, 5, typeof(GameFramework.Sound.PlaySoundParams));
                    
                        int __cl_gen_ret = __cl_gen_to_be_invoked.PlaySound( soundAssetName, soundGroupName, priority, playSoundParams );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 6&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& translator.Assignable<GameFramework.Sound.PlaySoundParams>(L, 5)&& translator.Assignable<object>(L, 6)) 
                {
                    string soundAssetName = LuaAPI.lua_tostring(L, 2);
                    string soundGroupName = LuaAPI.lua_tostring(L, 3);
                    int priority = LuaAPI.xlua_tointeger(L, 4);
                    ...
                    object userData = translator.GetObject(L, 6, typeof(object));
                        ...
                        int __cl_gen_ret = __cl_gen_to_be_invoked.PlaySound( soundAssetName, soundGroupName, priority, playSoundParams, userData );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 6&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& translator.Assignable<GameFramework.Sound.PlaySoundParams>(L, 5)&& translator.Assignable<UnityGameFramework.Runtime.Entity>(L, 6)) 
                {
                    ...
                    int priority = LuaAPI.xlua_tointeger(L, 4);
                    GameFramework.Sound.PlaySoundParams playSoundParams = (GameFramework.Sound.PlaySoundParams)translator.GetObject(L, 5, typeof(GameFramework.Sound.PlaySoundParams));
                    UnityGameFramework.Runtime.Entity bindingEntity = (UnityGameFramework.Runtime.Entity)translator.GetObject(L, 6, typeof(UnityGameFramework.Runtime.Entity));
                    
                        int __cl_gen_ret = __cl_gen_to_be_invoked.PlaySound( soundAssetName, soundGroupName, priority, playSoundParams, bindingEntity );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 6&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& translator.Assignable<GameFramework.Sound.PlaySoundParams>(L, 5)&& translator.Assignable<UnityEngine.Vector3>(L, 6)) 
                {
                    string soundAssetName = LuaAPI.lua_tostring(L, 2);
                    string soundGroupName = LuaAPI.lua_tostring(L, 3);
                    int priority = LuaAPI.xlua_tointeger(L, 4);
                    GameFramework.Sound.PlaySoundParams playSoundParams = (GameFramework.Sound.PlaySoundParams)translator.GetObject(L, 5, typeof(GameFramework.Sound.PlaySoundParams));
                    UnityEngine.Vector3 worldPosition;translator.Get(L, 6, out worldPosition);
                    
                        int __cl_gen_ret = __cl_gen_to_be_invoked.PlaySound( soundAssetName, soundGroupName, priority, playSoundParams, worldPosition );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 7&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& translator.Assignable<GameFramework.Sound.PlaySoundParams>(L, 5)&& translator.Assignable<UnityGameFramework.Runtime.Entity>(L, 6)&& translator.Assignable<object>(L, 7)) 
                {
                    ...
                    object userData = translator.GetObject(L, 7, typeof(object));
                        ...
                        int __cl_gen_ret = __cl_gen_to_be_invoked.PlaySound( soundAssetName, soundGroupName, priority, playSoundParams, bindingEntity, userData );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 7&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& translator.Assignable<GameFramework.Sound.PlaySoundParams>(L, 5)&& translator.Assignable<UnityEngine.Vector3>(L, 6)&& translator.Assignable<object>(L, 7)) 
                {
                    ...
                    object userData = translator.GetObject(L, 7, typeof(object));
                        ...
                        int __cl_gen_ret = __cl_gen_to_be_invoked.PlaySound( soundAssetName, soundGroupName, priority, playSoundParams, worldPosition, userData );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
