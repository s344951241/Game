...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemMainModuleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 0, 40, 40);
        ...
        static int _g_get_flipRotation(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.MainModule __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                LuaAPI.lua_pushnumber(L, __cl_gen_to_be_invoked.flipRotation);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_useUnscaledTime(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.MainModule __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.useUnscaledTime);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_emitterVelocityMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.MainModule __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                translator.Push(L, __cl_gen_to_be_invoked.emitterVelocityMode);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_stopAction(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.MainModule __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                translator.Push(L, __cl_gen_to_be_invoked.stopAction);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_flipRotation(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.MainModule __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                __cl_gen_to_be_invoked.flipRotation = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _s_set_useUnscaledTime(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.MainModule __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                __cl_gen_to_be_invoked.useUnscaledTime = LuaAPI.lua_toboolean(L, 2);
        ...
        static int _s_set_emitterVelocityMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.MainModule __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                UnityEngine.ParticleSystemEmitterVelocityMode __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
				__cl_gen_to_be_invoked.emitterVelocityMode = __cl_gen_value;
        ...
        static int _s_set_stopAction(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.MainModule __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                UnityEngine.ParticleSystemStopAction __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
				__cl_gen_to_be_invoked.stopAction = __cl_gen_value;
