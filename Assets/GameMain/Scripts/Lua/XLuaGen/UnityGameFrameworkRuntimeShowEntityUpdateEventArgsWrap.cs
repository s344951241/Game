...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityGameFrameworkRuntimeShowEntityUpdateEventArgsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityGameFramework.Runtime.ShowEntityUpdateEventArgs);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "EventId", UnityGameFramework.Runtime.ShowEntityUpdateEventArgs.EventId);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityGameFramework.Runtime.ShowEntityUpdateEventArgs __cl_gen_ret = new UnityGameFramework.Runtime.ShowEntityUpdateEventArgs();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityGameFramework.Runtime.ShowEntityUpdateEventArgs constructor!");
        ...
        static int _m_Clear(RealStatePtr L)
        {
		    try {
                ...
                UnityGameFramework.Runtime.ShowEntityUpdateEventArgs __cl_gen_to_be_invoked = (UnityGameFramework.Runtime.ShowEntityUpdateEventArgs)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Fill(RealStatePtr L)
        {
		    try {
                ...
                {
                    GameFramework.Entity.ShowEntityUpdateEventArgs e = (GameFramework.Entity.ShowEntityUpdateEventArgs)translator.GetObject(L, 2, typeof(GameFramework.Entity.ShowEntityUpdateEventArgs));
                    
                        UnityGameFramework.Runtime.ShowEntityUpdateEventArgs __cl_gen_ret = __cl_gen_to_be_invoked.Fill( e );
                        translator.Push(L, __cl_gen_ret);
