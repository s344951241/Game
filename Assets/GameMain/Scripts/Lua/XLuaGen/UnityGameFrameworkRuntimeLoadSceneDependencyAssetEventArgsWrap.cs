...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityGameFrameworkRuntimeLoadSceneDependencyAssetEventArgsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityGameFramework.Runtime.LoadSceneDependencyAssetEventArgs);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "EventId", UnityGameFramework.Runtime.LoadSceneDependencyAssetEventArgs.EventId);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityGameFramework.Runtime.LoadSceneDependencyAssetEventArgs __cl_gen_ret = new UnityGameFramework.Runtime.LoadSceneDependencyAssetEventArgs();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityGameFramework.Runtime.LoadSceneDependencyAssetEventArgs constructor!");
        ...
        static int _m_Clear(RealStatePtr L)
        {
		    try {
                ...
                UnityGameFramework.Runtime.LoadSceneDependencyAssetEventArgs __cl_gen_to_be_invoked = (UnityGameFramework.Runtime.LoadSceneDependencyAssetEventArgs)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Fill(RealStatePtr L)
        {
		    try {
                ...
                {
                    GameFramework.Scene.LoadSceneDependencyAssetEventArgs e = (GameFramework.Scene.LoadSceneDependencyAssetEventArgs)translator.GetObject(L, 2, typeof(GameFramework.Scene.LoadSceneDependencyAssetEventArgs));
                    
                        UnityGameFramework.Runtime.LoadSceneDependencyAssetEventArgs __cl_gen_ret = __cl_gen_to_be_invoked.Fill( e );
                        translator.Push(L, __cl_gen_ret);
