    ...
    public class UnityGameFrameworkRuntimeUIComponentWrap 
    {
        ...
        static int _m_GetAllUIGroups(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Collections.Generic.List<GameFramework.UI.IUIGroup>>(L, 2)) 
                {
                    System.Collections.Generic.List<GameFramework.UI.IUIGroup> results = (System.Collections.Generic.List<GameFramework.UI.IUIGroup>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<GameFramework.UI.IUIGroup>));
                    
                    __cl_gen_to_be_invoked.GetAllUIGroups( results );
        ...
        static int _m_GetUIForms(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Collections.Generic.List<UnityGameFramework.Runtime.UIForm>>(L, 3)) 
                {
                    string uiFormAssetName = LuaAPI.lua_tostring(L, 2);
                    System.Collections.Generic.List<UnityGameFramework.Runtime.UIForm> results = (System.Collections.Generic.List<UnityGameFramework.Runtime.UIForm>)translator.GetObject(L, 3, typeof(System.Collections.Generic.List<UnityGameFramework.Runtime.UIForm>));
                    
                    __cl_gen_to_be_invoked.GetUIForms( uiFormAssetName, results );
        ...
        static int _m_GetAllLoadedUIForms(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Collections.Generic.List<UnityGameFramework.Runtime.UIForm>>(L, 2)) 
                {
                    System.Collections.Generic.List<UnityGameFramework.Runtime.UIForm> results = (System.Collections.Generic.List<UnityGameFramework.Runtime.UIForm>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<UnityGameFramework.Runtime.UIForm>));
                    
                    __cl_gen_to_be_invoked.GetAllLoadedUIForms( results );
        ...
        static int _m_GetAllLoadingUIFormSerialIds(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Collections.Generic.List<int>>(L, 2)) 
                {
                    ...
                    __cl_gen_to_be_invoked.GetAllLoadingUIFormSerialIds( results );
		    ...
		    try {
                ...
                if(__gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    int priority = LuaAPI.xlua_tointeger(L, 4);
                        ...
                        int __cl_gen_ret = __cl_gen_to_be_invoked.OpenUIForm( uiFormAssetName, uiGroupName, priority );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 5&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)) 
                {
                    string uiFormAssetName = LuaAPI.lua_tostring(L, 2);
                    string uiGroupName = LuaAPI.lua_tostring(L, 3);
                    int priority = LuaAPI.xlua_tointeger(L, 4);
                    bool pauseCoveredUIForm = LuaAPI.lua_toboolean(L, 5);
                    
                        int __cl_gen_ret = __cl_gen_to_be_invoked.OpenUIForm( uiFormAssetName, uiGroupName, priority, pauseCoveredUIForm );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 5&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& translator.Assignable<object>(L, 5)) 
                {
                    ...
                    object userData = translator.GetObject(L, 5, typeof(object));
                        ...
                        int __cl_gen_ret = __cl_gen_to_be_invoked.OpenUIForm( uiFormAssetName, uiGroupName, priority, userData );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 6&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)&& translator.Assignable<object>(L, 6)) 
                {
                    string uiFormAssetName = LuaAPI.lua_tostring(L, 2);
                    string uiGroupName = LuaAPI.lua_tostring(L, 3);
                    int priority = LuaAPI.xlua_tointeger(L, 4);
                    ...
                    object userData = translator.GetObject(L, 6, typeof(object));
                        ...
                        int __cl_gen_ret = __cl_gen_to_be_invoked.OpenUIForm( uiFormAssetName, uiGroupName, priority, pauseCoveredUIForm, userData );
                        LuaAPI.xlua_pushinteger(L, __cl_gen_ret);
        ...
        static int _m_SetUIFormInstanceLocked(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetUIFormInstanceLocked( uiForm, locked );
        ...
        static int _m_SetUIFormInstancePriority(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetUIFormInstancePriority( uiForm, priority );
