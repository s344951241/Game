		    ...
		    try {
                ...
                
                {
                    System.Type type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        UnityEngine.Component __cl_gen_ret = __cl_gen_to_be_invoked.GetOrAddComponent( type );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_InScene(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        bool __cl_gen_ret = __cl_gen_to_be_invoked.InScene(  );
                        LuaAPI.lua_pushboolean(L, __cl_gen_ret);
        ...
        static int _m_SetLayerRecursively(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetLayerRecursively( layer );
