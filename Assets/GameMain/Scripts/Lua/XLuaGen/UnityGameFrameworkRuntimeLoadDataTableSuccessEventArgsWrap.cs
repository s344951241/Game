...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityGameFrameworkRuntimeLoadDataTableSuccessEventArgsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityGameFramework.Runtime.LoadDataTableSuccessEventArgs);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "EventId", UnityGameFramework.Runtime.LoadDataTableSuccessEventArgs.EventId);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityGameFramework.Runtime.LoadDataTableSuccessEventArgs __cl_gen_ret = new UnityGameFramework.Runtime.LoadDataTableSuccessEventArgs();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityGameFramework.Runtime.LoadDataTableSuccessEventArgs constructor!");
        ...
        static int _m_Clear(RealStatePtr L)
        {
		    try {
                ...
                UnityGameFramework.Runtime.LoadDataTableSuccessEventArgs __cl_gen_to_be_invoked = (UnityGameFramework.Runtime.LoadDataTableSuccessEventArgs)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Fill(RealStatePtr L)
        {
		    try {
                ...
                {
                    GameFramework.DataTable.LoadDataTableSuccessEventArgs e = (GameFramework.DataTable.LoadDataTableSuccessEventArgs)translator.GetObject(L, 2, typeof(GameFramework.DataTable.LoadDataTableSuccessEventArgs));
                    
                        UnityGameFramework.Runtime.LoadDataTableSuccessEventArgs __cl_gen_ret = __cl_gen_to_be_invoked.Fill( e );
                        translator.Push(L, __cl_gen_ret);
