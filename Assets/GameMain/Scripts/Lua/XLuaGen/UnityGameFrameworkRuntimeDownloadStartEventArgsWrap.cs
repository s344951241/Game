...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityGameFrameworkRuntimeDownloadStartEventArgsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityGameFramework.Runtime.DownloadStartEventArgs);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "EventId", UnityGameFramework.Runtime.DownloadStartEventArgs.EventId);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityGameFramework.Runtime.DownloadStartEventArgs __cl_gen_ret = new UnityGameFramework.Runtime.DownloadStartEventArgs();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityGameFramework.Runtime.DownloadStartEventArgs constructor!");
        ...
        static int _m_Clear(RealStatePtr L)
        {
		    try {
                ...
                UnityGameFramework.Runtime.DownloadStartEventArgs __cl_gen_to_be_invoked = (UnityGameFramework.Runtime.DownloadStartEventArgs)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Fill(RealStatePtr L)
        {
		    try {
                ...
                {
                    GameFramework.Download.DownloadStartEventArgs e = (GameFramework.Download.DownloadStartEventArgs)translator.GetObject(L, 2, typeof(GameFramework.Download.DownloadStartEventArgs));
                    
                        UnityGameFramework.Runtime.DownloadStartEventArgs __cl_gen_ret = __cl_gen_to_be_invoked.Fill( e );
                        translator.Push(L, __cl_gen_ret);
