    ...
    public class UnityGameFrameworkRuntimeEventComponentWrap 
    {
		    ...
		    try {
                ...
                
                {
                    int id = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        int __cl_gen_ret = __cl_gen_to_be_invoked.Count( id );
        ...
        static int _m_SetDefaultHandler(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.EventHandler<GameFramework.Event.GameEventArgs> handler = translator.GetDelegate<System.EventHandler<GameFramework.Event.GameEventArgs>>(L, 2);
                    
                    __cl_gen_to_be_invoked.SetDefaultHandler( handler );
        ...
        static int _g_get_EventHandlerCount(RealStatePtr L)
        {
		    try {
                ...
                UnityGameFramework.Runtime.EventComponent __cl_gen_to_be_invoked = (UnityGameFramework.Runtime.EventComponent)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, __cl_gen_to_be_invoked.EventHandlerCount);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_EventCount(RealStatePtr L)
        {
		    try {
                ...
                UnityGameFramework.Runtime.EventComponent __cl_gen_to_be_invoked = (UnityGameFramework.Runtime.EventComponent)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, __cl_gen_to_be_invoked.EventCount);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
