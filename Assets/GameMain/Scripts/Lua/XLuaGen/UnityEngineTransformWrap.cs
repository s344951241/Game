...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTransformWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 40, 19, 13);
        ...
        static int _m_SetPositionX(RealStatePtr L)
        {
		    try {
                ...
                {
                    float newValue = (float)LuaAPI.lua_tonumber(L, 2);
                    
                    __cl_gen_to_be_invoked.SetPositionX( newValue );
        ...
        static int _m_SetPositionY(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetPositionY( newValue );
        ...
        static int _m_SetPositionZ(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetPositionZ( newValue );
        ...
        static int _m_AddPositionX(RealStatePtr L)
        {
		    try {
                ...
                {
                    float deltaValue = (float)LuaAPI.lua_tonumber(L, 2);
                    
                    __cl_gen_to_be_invoked.AddPositionX( deltaValue );
        ...
        static int _m_AddPositionY(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.AddPositionY( deltaValue );
        ...
        static int _m_AddPositionZ(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.AddPositionZ( deltaValue );
        ...
        static int _m_SetLocalPositionX(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetLocalPositionX( newValue );
        ...
        static int _m_SetLocalPositionY(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetLocalPositionY( newValue );
        ...
        static int _m_SetLocalPositionZ(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetLocalPositionZ( newValue );
        ...
        static int _m_AddLocalPositionX(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.AddLocalPositionX( deltaValue );
        ...
        static int _m_AddLocalPositionY(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.AddLocalPositionY( deltaValue );
        ...
        static int _m_AddLocalPositionZ(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.AddLocalPositionZ( deltaValue );
        ...
        static int _m_SetLocalScaleX(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetLocalScaleX( newValue );
        ...
        static int _m_SetLocalScaleY(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetLocalScaleY( newValue );
        ...
        static int _m_SetLocalScaleZ(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.SetLocalScaleZ( newValue );
        ...
        static int _m_AddLocalScaleX(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.AddLocalScaleX( deltaValue );
        ...
        static int _m_AddLocalScaleY(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.AddLocalScaleY( deltaValue );
        ...
        static int _m_AddLocalScaleZ(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.AddLocalScaleZ( deltaValue );
        ...
        static int _m_LookAt2D(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector2 lookAtPoint2D;translator.Get(L, 2, out lookAtPoint2D);
                    
                    __cl_gen_to_be_invoked.LookAt2D( lookAtPoint2D );
