...
namespace Game.Editor
{
    public class DeviceModelConfigEditorWindow : EditorWindow
    {
        ...
        [MenuItem("Game Tools/Device Model Config Editor")]
        ...
        [MenuItem("Game Tools/CreateAsset")]
        public static void CreateAsset()
        {
            ScriptableObject config = ScriptableObject.CreateInstance<DeviceModelConfig>();

            AssetDatabase.CreateAsset(config, "Assets/GameMain/Configs/DeviceModelConfig.asset");
        }
