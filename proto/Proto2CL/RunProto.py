...
crc16HigtTab=[0x00, 0xC1, 0x81, 0x40, 0x01, 0xC0, 0x80, 0x41, 0x01, 0xC0,
...
crc16LowTab= [0x00, 0xC0, 0xC1, 0x01, 0xC3, 0x03, 0x02, 0xC2, 0xC6, 0x06,
...
def getCrc32(strs):
	...
	for i in range(count):
		crc = crc32Tab[(crc^bys[i])&0xff]^(crc>>8)
...
def getCrc16(strs):
	...
	for i in range(count):
		index =crcHigh^bys[i]
		crcHigh = crcLow^crc16HigtTab[index]
		crcLow = crc16LowTab[index]
